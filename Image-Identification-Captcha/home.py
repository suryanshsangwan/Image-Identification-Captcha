...
root.geometry("1280x766+0+0")

#frame1
f1=Frame(root,height='766',width='1280',bg='#FF6F00',cursor='arrow')
f1.propagate(0)
f1.pack()
...
exit.place(x=590,y=505)
#+++++++++++++++++++++++++++++++++++++++++++++++++++Next Frame++++++++++++++++++++++++++++++++++++++++++++++++++++++
f2=Frame(root,height='766',width='1280',bg='#EEEEEE',cursor='arrow')
f2.propagate(0)
f2.pack()
...
insideFrame.pack()
insideFrame.place(x=400,y=60)

#defining verifyframe inside which two button reset and verify is placed
verifyFrame=Frame(f2,height=45,width=604,bg='#888888')
verifyFrame.pack()
verifyFrame.place(x=400,y=670)
#defining DescLabel for displaying the task that user has to perform 
DescLabel=Label(f2,height=3,width=60,text='',bd=3,bg='#90CAF9',font=('Arial',12,'bold'))
DescLabel.pack()
DescLabel.place(x=400,y=0)
